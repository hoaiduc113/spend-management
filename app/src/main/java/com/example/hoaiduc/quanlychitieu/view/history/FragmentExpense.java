...
/**
 * Created by hoaiduc on 4/11/2018.
 */

public class FragmentExpense extends Fragment implements ViewHistory
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.layout_fragment_quickview,container,false);
        //get value userid
        ...
        presenterLogicHisotory.perFormHistory(userId,0,date);
        ...
        timeline.setOnDateSelectedListener(new DatePickerTimeline.OnDateSelectedListener() {
            ...
            public void onDateSelected(int year, int month, int day, int index) {
               ...
               String days=String.valueOf(year+"-"+months+"-"+day);
                Log.d(TAG,""+date);
                historyMoneyIntOutList.clear();
                presenterLogicHisotory.perFormHistory(userId,0,days);
...
//                timeline.setSelectedDate(2018, Calendar.MONTH+1,dates);
//                Log.d(TAG,date+"");
//                historyMoneyIntOutList.clear();
//                presenterLogicHisotory.perFormHistory(userId,0,date);
//                break;
