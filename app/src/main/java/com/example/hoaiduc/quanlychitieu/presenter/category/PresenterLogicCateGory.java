...
/**
 * Created by hoaiduc on 2/26/2018.
 */

public class PresenterLogicCateGory implements PresenterCategory
{
    ModelCategory modelCategory;
    ViewCategory viewCategory;
    public PresenterLogicCateGory(ViewCategory viewCategory)
    {
        this.viewCategory=viewCategory;
        modelCategory=new ModelCategory();

    }
    //hiện thị danh mục cha
    @Override
    public void layDanhSach(int userid)
    {
        ...
        hsgroup.put("group",String.valueOf(0));
        attrs.add(hsTen);
        attrs.add(hsgroup);
        attrs.add(hsuserid);
